  ...
  const resources = [
    {
      ...
      description: "A comprehensive guide for teachers new to educational technology.",
      type: "PDF Guide",
      date: "June 15, 2023",
    },
    {
      ...
      description: "Learn strategies for designing online lessons that keep students motivated.",
    ...
    },
    {
      ...
      description: "Templates and tools for creating effective digital assessments.",
      type: "Template Pack",
      date: "May 10, 2023",
    },
    {
      ...
      description: "Case studies on successful technology integration in science and math classrooms.",
    ...
    },
    {
      ...
      description: "Step-by-step tutorial on maximizing your interactive whiteboard.",
      type: "Video Tutorial",
      date: "April 5, 2023",
    },
    {
      ...
      description: "Ensuring your digital materials are accessible to all students.",
      type: "Recorded Webinar",
      date: "March 18, 2023",
    },
    {
      ...
      description: "A comparison of popular classroom management applications.",
    ...
    },
    {
      ...
      description: "Research on the effectiveness of one-to-one device programs in schools.",
      type: "Research Report",
          ...
          <div className="resources-grid">
            {filteredResources.map((resource) => (
              <div key={resource.id} className="resource-card">
                <div className="resource-card-image">
                  <img 
                    src={resource.id === 1 ? "https://images.unsplash.com/photo-1585247226801-bc613c441316?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" : 
            ...
            {filteredResources.length === 0 && (
              <div className="no-resources">
                <p>No resources found in this category. Please check back later.</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="container">
          <div className="featured-resource-content">
            <div className="featured-resource-text">
              ...
              <p>
                This comprehensive guide covers everything you need to know about implementing blended learning in your
                classroom, from technology setup to curriculum design.
              </p>
              <ul className="featured-resource-details">
                <li>
                  <i className="fas fa-file-pdf"></i> 75-page PDF Guide
                </li>
                <li>
                  <i className="fas fa-video"></i> 10 Instructional Videos
                </li>
                <li>
                  <i className="fas fa-file-alt"></i> 25 Ready-to-use Templates
                </li>
              </ul>
              <Link to="/resources/featured" className="btn btn-primary">
                Download Free Guide
              </Link>
            </div>
        ...
        <div className="container">
          ...
          <div className="category-cards">
            <div className="category-card">
              <div className="category-icon" style={{ backgroundColor: "rgba(47, 111, 204, 0.1)" }}>
                <i className="fas fa-book" style={{ color: "var(--primary-blue)" }}></i>
              </div>
              <h3>Guides & Tutorials</h3>
              <p>Step-by-step instructions for implementing educational technology</p>
              <Link to="/resources" className="category-link" onClick={() => setActiveCategory("guides")}>
                View Guides <i className="fas fa-arrow-right"></i>
              </Link>
            </div>
            <div className="category-card">
              <div className="category-icon" style={{ backgroundColor: "rgba(68, 187, 164, 0.1)" }}>
                <i className="fas fa-video" style={{ color: "var(--secondary-teal)" }}></i>
              </div>
              <h3>Webinars</h3>
              <p>Recorded sessions with experts on various educational technology topics</p>
              <Link to="/resources" className="category-link" onClick={() => setActiveCategory("webinars")}>
                View Webinars <i className="fas fa-arrow-right"></i>
              </Link>
            </div>
            <div className="category-card">
              <div className="category-icon" style={{ backgroundColor: "rgba(233, 79, 55, 0.1)" }}>
                <i className="fas fa-tools" style={{ color: "var(--secondary-red)" }}></i>
              </div>
              <h3>Tools & Templates</h3>
              <p>Ready-to-use resources to save you time in implementing technology</p>
              <Link to="/resources" className="category-link" onClick={() => setActiveCategory("tools")}>
                View Tools <i className="fas fa-arrow-right"></i>
              </Link>
            </div>
            <div className="category-card">
              <div className="category-icon" style={{ backgroundColor: "rgba(35, 52, 99, 0.1)" }}>
                <i className="fas fa-chart-bar" style={{ color: "var(--primary-dark-blue)" }}></i>
              </div>
              <h3>Research & Case Studies</h3>
              <p>Evidence-based research on educational technology effectiveness</p>
              <Link to="/resources" className="category-link" onClick={() => setActiveCategory("research")}>
        ...
        <div className="container">
          <div className="resources-newsletter-content">
            <div className="resources-newsletter-text">
              ...
              <p>
                Subscribe to our newsletter to receive the latest educational technology resources directly to your
                inbox, before they're published on our website.
              </p>
            </div>
