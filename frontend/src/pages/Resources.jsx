    ...
    return (
        <div className="resources-page">
            ...
            <section className="section resources-grid-section">
                <div className="group p-3 rounded-2xl bg-indigo-500 flex items-center w-4/5 mx-auto gap-3">
                <a
                    className="text-lg text-gray-500 lg:text-2xl hover:decoration-red-300 hover:text-red-400 underline underline-offset-2"
